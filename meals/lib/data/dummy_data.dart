...
const availableCategories = [
  ...
  Category(id: 'c11', title: 'Indian', color: Color.fromARGB(255, 37, 83, 168))
];
...
const dummyMeals = [
  ...
  Meal(
    ...
    steps: [
      ...
      'Sprinkle kasuri methi and garam masala. Stir well.',
  ...
  Meal(
    ...
    steps: [
      ...
      'Add the cooked chickpeas along with some of the cooking water.',
      'Mix well and let it simmer for 10-15 minutes.',
      'Add garam masala and dried mango powder. Stir well.',
      'Garnish with chopped coriander leaves and serve hot with rice or bhature.',
    ],
    duration: 45,
    complexity: Complexity.challenging,
    affordability: Affordability.affordable,
